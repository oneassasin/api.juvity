...
router.put('/lessonTypes/:lessonTypeID([0-9]+)/', permissions.permissionCheck(9), lessonTypesController.updateLessonType);
router.delete('/lessonTypes/:lessonTypeID([0-9]+)/', permissions.permissionCheck(9), lessonTypesController.deleteLessonType);
